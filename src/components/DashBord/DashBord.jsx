      ...
      <div className="w-[95%] bg-[#F5F5F5] md:w-[90%]  m-auto">
          ...
          <div className="flex">
            <div className="drawer block p-5 w-[80px] ">
              ...
              <div className="drawer-content">
                ...
                <label
                  htmlFor="my-drawer"
                  className=" fixed  bg-white text-[28px] text-black p-2 border rounded-xl drawer-button"
                >
        ...
        <div className="  flex">
          <div className="w-[35%] hidden md:hidden lg:block h-screen  bg-[#006666] ">
            <h1 className="text-white font-[600] text-[43px] text-center mt-4">
              EnrozzZ
            </h1>
            ...
            <div>
              <ul className="text-white text-[20px] text-start ml-8 space-y-5 list-none">
                <li className="mt-10">
                  {userSingleData?.role === "admin" ? (
                    <Link className="flex space-y-10 items-center" to={""}>
                      <MdOutlineAdminPanelSettings className="mr-2"></MdOutlineAdminPanelSettings>
                      Admin Profile
                    </Link>
                  ) : (
                    <Link className="flex space-y-10 items-center" to={""}>
